...
CREATE TABLE `club_event` (
  ...
  `evenet_name` varchar(50) DEFAULT NULL,
...
ALTER TABLE `club_event`
  ...
  ADD CONSTRAINT `club_event_ibfk_2` FOREIGN KEY (`advisor_id`) REFERENCES `advisor` (`advisor_id`);
...
--
ALTER TABLE `join_event`
  ADD CONSTRAINT `join_event_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `club_event` (`event_id`),
  ADD CONSTRAINT `join_event_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`);
COMMIT;
